  ...
  public SecurityFilterChain filtrosSeguranca(HttpSecurity http) throws Exception {
    return http
        .authorizeHttpRequests(req -> {
          ...
          req.requestMatchers(HttpMethod.GET, "/consultas/**").permitAll();
        ...
        .logout(logout -> logout
            ...
            .permitAll())
        .rememberMe(rememberMe -> rememberMe.key("lembrarDeMim") //ideal a key fiar em uma secret
            // .alwaysRemember(true)
            .tokenValiditySeconds(6_04800) //7 dias
        )
